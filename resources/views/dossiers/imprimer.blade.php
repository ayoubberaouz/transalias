...
<head>
    ...
    <title>FACTURE ET NOTE DE DEBIT</title>
    <style>
        body {
    ...
    <div class="invoice">
        ...
        <div>
            ...
            <div class="invoice-info" style="float:right; width: 24rem; margin-top: 30px">
                <table>
                    <tr>
                        <td style="text-align: left"><b>Client :</b> {{ $facturesDossier->dossiers->clients->nom }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: left"><b>Adresse :</b> {{ $facturesDossier->dossiers->clients->adresse }}
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="height: 400px; text-align: left; width: 380px">
                            ...
                            <br>
                            <span>=> {{ $facturesDossier->dossiers->destinsation }}
                                ({{ $facturesDossier->dossiers->lieu_livraison }})</span>
                            <br>
                            <br>
                            <br>
                            <br>
            ...
            <table class="table-total">
                <tr>
                    ...
                    <td style="text-align: center">
                        {{ $total_ht_facture . ' ' . $facturesDossier->a_paye }}
                    </td>
                </tr>
                <tr>
        ...
        <div class="invoice-info" style="margin-top: 100px">
            ...
            <span>{{ $numberInWords_facture }}</span>
            <br>
        ...
        <div>
            <div class="invoice-info">
                <table style="padding-top: 2em;">
                    ...
                    <tr>
                        <td style="text-align: left"><b>Date Note de Débit
                                :</b>{{ $noteDebitDossier->datenotationdebit }}</td>
                    </tr>
                    <tr>
                ...
                <table>
                    <tr>
                        <td style="text-align: left"><b>Client :</b>
                            {{ $facturesDossier->dossiers ? $noteDebitDossier->dossiers->clients->nom : '-' }}
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left"><b>Adresse :</b>
                            {{ $facturesDossier->dossiers ? $noteDebitDossier->dossiers->clients->adresse : '-' }}
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <tr>
                        ...
                        <td style="height: 400px; text-align: right">
                            ...
                            @if ($noteDebitDossier->notedebit1)
                                <span>{{ $noteDebitDossier->notedebit1 . ' ' . $noteDebitDossier->a_paye }} </span>
                            @endif
                            <br>
                            @if ($noteDebitDossier->notedebit2)
                                <span>{{ $noteDebitDossier->notedebit2 . ' ' . $noteDebitDossier->a_paye }} </span>
                            @endif
                            <br>
                            @if ($noteDebitDossier->notedebit3)
                                <span>{{ $noteDebitDossier->notedebit3 . ' ' . $noteDebitDossier->a_paye }} </span>
                            @endif
                            <br>
                            @if ($noteDebitDossier->notedebit4)
                                <span>{{ $noteDebitDossier->notedebit4 . ' ' . $noteDebitDossier->a_paye }} </span>
                            @endif
                            <br>
                            @if ($noteDebitDossier->notedebit5)
                                <span>{{ $noteDebitDossier->notedebit5 . ' ' . $noteDebitDossier->a_paye }} </span>
                            @endif
                            <br>
                            <br>
                        </td>
        ...
        <div class="invoice-info" style="display: inline-block; float:right; margin-top: 10px">
            <table class="table-total">
                <tr>
                    <td style="text-align: left">Montant HT</td>
                    <td style="text-align: center">
                        {{ $total_ht_note . ' ' . $noteDebitDossier->a_paye }}
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left">TVA</td>

...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h4>Liste des dossiers non facturés</h4>
                </div>
            </div>

            <form method="GET" action="{{ route('index-non-facturer') }}">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-md-1 mb-1" style="margin-top: 2rem">
    ...
    <div class="content px-3">
        ...
        <div class="card">
            <div class="card-body p-0">
                @include('factures_dossiers.table-non-facturer')

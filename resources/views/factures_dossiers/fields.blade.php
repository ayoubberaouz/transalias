            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-3">
                        ...
                        {{ $dossiers->date_livraison ? $dossiers->date_livraison->format('Y-m-d') : '' }}
                    </div>
                ...
                <div class="row">
                    ...
                    @for ($i = 1; $i <= 5; $i++)
                        <div class="form-group col-md-6 col-lg-6">
                            ...
                            {!! Form::text("designation$i", null, ['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group col-md-6 col-lg-6">
                            {!! Form::label("facturer$i", "A Facturer $i :" . ($i == 1 ? ' *' : '')) !!}
                            {!! Form::text("facturer$i", null, ['class' => 'form-control']) !!}
                        </div>
                    @endfor

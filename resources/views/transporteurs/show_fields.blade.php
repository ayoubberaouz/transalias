...
<div class="col-sm-3">
    ...
    <p>{{ $transporteur->fax ? $transporteur->fax : '-' }}</p>
</div>

<!-- Gsm Field -->
<div class="col-sm-3">
    {!! Form::label('gsm', __('models/transporteurs.fields.gsm') . ' :') !!}
    <p>{{ $transporteur->gsm ? $transporteur->gsm : '-' }}</p>
</div>

<!-- Email Field -->
<div class="col-sm-3">
    {!! Form::label('email', __('models/transporteurs.fields.email') . ' :') !!}
    <p>{{ $transporteur->email ? $transporteur->email : '-' }}</p>
</div>

<!-- Adresse Field -->
<div class="col-sm-3">
    {!! Form::label('adresse', __('models/transporteurs.fields.adresse') . ' :') !!}
    <p>{{ $transporteur->adresse ? $transporteur->adresse : '-' }}</p>
</div>
...
<div class="col-sm-3">
    ...
    <p>{{ $transporteur->Ncompte ? $transporteur->Ncompte : '-' }}</p>
</div>
